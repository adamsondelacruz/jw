# CO-53 — Easy Guide for the Convention Committee

> Local working aid based on [CO-1 2:8-11](../CO-1.html#co1-2-8) and the [Convention Personnel Report (CO-53)](forms/01-CO-53_E.pdf). It does not replace the current official form or later branch direction.

## Short answer: Who evaluates the brothers?

**It is not every department overseer, and it is not the Convention Committee acting alone.**

The evaluation group is:

1. Convention Committee coordinator
2. Program overseer
3. Rooming overseer
4. Confirmed Convention Committee member assistants
5. Attendant overseer
6. Cleaning overseer

For this convention, the expected group is currently:

- Adamson dela Cruz — coordinator
...
## What is the purpose of CO-53?

CO-53 helps the branch identify brothers who may qualify to serve on Convention Committees. It is not an award, popularity vote, or general performance review of every volunteer. Ratings and recommendations must be balanced, realistic, and based on meaningful observation. ([CO-1 2:8-10](../CO-1.html#co1-2-8))

## Step 1 — Prepare one master copy early

The coordinator prepares **one master CO-53**, entering the necessary names and statistics. Use full names—no nicknames or abbreviations. ([CO-1 2:8](../CO-1.html#co1-2-8))

The printed form already provides spaces for:
...
- Attendant overseer
- Cleaning overseer
- Additional brothers who may qualify for Convention Committee service

For each person, gather the information requested on the form:

- Full name
- Date of birth and baptism
- Congregation
- Current convention assignment (“Serves as”)

Do not guess missing personal statistics. Confirm them through an authorised source or directly with the brother.

## Step 2 — Circulate the master copy to the observation group

Send the master copy electronically, as soon as possible, to every member of the evaluation group listed above. This gives them time to make meaningful observations during preparation and the convention. ([CO-1 2:8](../CO-1.html#co1-2-8))
...
The four rating areas on CO-53 are:

| Rating area | Plain-language question |
|---|---|
| Balance and reasonableness | Does he exercise sound judgment and respond reasonably when circumstances change? |
| Organising ability | Can he plan, coordinate people and tasks, and keep important work moving? |
| Dependability | Does he follow through reliably and communicate when help or adjustment is needed? |
| Dealings with others | Is he loving, respectful, cooperative, and able to give or receive direction well? |
...
During the convention, the committee discusses and agrees on any additional brothers who should be included. A brother does not have to serve first as a committee-member assistant, although experience as overseer of a large department is preferred. ([CO-1 2:9](../CO-1.html#co1-2-9))

Include an additional brother only when the group has enough direct observation and information to make a meaningful recommendation.

## Step 5 — Meet after the convention and agree on one evaluation

After the convention, the complete evaluation group meets prayerfully to review every person listed. The coordinator sets the pace but must not dominate the discussion. The final report should express the group’s balanced, realistic agreement. ([CO-1 2:10](../CO-1.html#co1-2-10))

Important meeting rule:

> When a member of the evaluation group is being discussed, he steps out of the room. When he returns, the group normally does not reopen or change his evaluation.

For each person, agree on:

1. The four A–D ratings
2. Whether he presently qualifies as committee coordinator, program overseer, and/or rooming overseer
3. The size of convention he could serve in that position
...
If the group believes a brother is seriously deficient in an area, **two members of the group** speak with him before submission. The report records the counsel given and his response. ([CO-1 2:11](../CO-1.html#co1-2-11))

The form specifically requires an explanation when “Poor” is selected for:

- Balance and reasonableness
- Dealings with others

Do not surprise a brother through a submitted report when the direction requires that he first be spoken to.

## Step 7 — Coordinator completes and submits the single final report

The coordinator checks the completed master for full names, required statistics, consistent ratings, qualification boxes, convention size, comments, and any counselling record. He then sends the report to the Convention and Assembly Desk:

- **Deadline:** No later than one week after the convention
- **Subject line:** Include `CO-53`
- **Responsibility:** The coordinator must do this personally; it is not delegated

See [CO-1 2:11](../CO-1.html#co1-2-11).

## Practical timeline for Auckland NS (TG)

| When | Action |
|---|---|
| 19 August committee meeting | Confirm the evaluation group, identify missing appointments, review this process, and assign preparation of the master data. Do not assign ratings yet. |
| As soon as appointments/data are complete | Coordinator prepares and securely circulates the master CO-53 to the evaluation group. |
| Before and during 30 October–1 November | Evaluators make fair, direct observations. Committee agrees on any additional candidates. |
| Immediately after the convention | Evaluation group meets; each member steps out while his own evaluation is discussed. |
| Before 8 November 2026 | Coordinator completes and submits the single agreed report with `CO-53` in the subject line. |
