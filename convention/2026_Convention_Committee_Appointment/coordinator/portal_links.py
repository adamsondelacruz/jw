...
ROLE_LINKS = {
    ...
    "lvea12@jwpub.org": [("role-attendant", "Attendant Overseer", "attendant"), ("role-baptism", "Baptism Assistant", "baptism")],
    ...
    "moratakent13@jwpub.org": [("role-program-overseer-assistant", "Program Overseer Assistant — TBC", None)],
    "23fernandom@jwpub.org": [("role-audio-video", "Audio/Video Overseer — TBC", "audio-video")],
    "joeld2@jwpub.org": [("role-audio-video", "Audio/Video Assistant", "audio-video")],
    "georgeintic4@jwpub.org": [("role-audio-video", "Audio/Video Assistant — TBC", "audio-video")],
